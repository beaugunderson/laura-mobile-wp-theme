...
<html <?php language_attributes(); ?>>
 <head profile="http://gmpg.org/xfn/11">
  ...
  <!--
  <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/css/jquery.mobile-1.2.0.min.css" />

  <script src="<?php bloginfo('template_directory'); ?>/lib/jquery-1.8.2.min.js"></script>
  <script src="<?php bloginfo('template_directory'); ?>/lib/jquery.mobile-1.2.0.min.js"></script>
  -->
